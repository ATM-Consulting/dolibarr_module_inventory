 ...
 */
class inventorybox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "inventory@inventory";
    public $boxlabel;
    public $depends = array("inventory");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/inventory/class/inventory.class.php";
